...
#ifndef HITLS_CRYPTO_SM4_PARALLEL
...
static const uint8_t KBOX_0_P[16][64] = {
	{
		0x92U, 0xd4U, 0x8aU, 0x4cU, 0xafU, 0xcaU, 0xb2U, 0x69U, 
		0x08U, 0x8dU, 0xf3U, 0x8dU, 0x4cU, 0x41U, 0x8cU, 0xbdU, 
		0x3fU, 0xbfU, 0x47U, 0x36U, 0x9cU, 0xe1U, 0xfcU, 0x58U, 
		0xa2U, 0x93U, 0xc9U, 0xc5U, 0xe0U, 0xbfU, 0xe8U, 0x80U, 
		0xaeU, 0x4cU, 0xafU, 0x55U, 0x18U, 0x63U, 0x2dU, 0xd1U, 
		0xa9U, 0x2aU, 0xf4U, 0xedU, 0x7dU, 0xe6U, 0xafU, 0x71U, 
		0xbdU, 0xc7U, 0x45U, 0x23U, 0x16U, 0x75U, 0x81U, 0x04U, 
		0xb5U, 0xb8U, 0x55U, 0x29U, 0x10U, 0x12U, 0xb9U, 0x1fU
	}, 
	{
		0xe1U, 0x73U, 0x15U, 0x7aU, 0x66U, 0x1eU, 0x46U, 0x96U, 
		0x43U, 0xacU, 0x24U, 0x3fU, 0xb1U, 0x6aU, 0x9cU, 0x7dU, 
		0xd5U, 0x90U, 0xb8U, 0xb5U, 0x0aU, 0xa4U, 0xbaU, 0x74U, 
		0xf7U, 0x08U, 0xb1U, 0x60U, 0x51U, 0x13U, 0x47U, 0xe4U, 
		0x2eU, 0x64U, 0xc4U, 0x12U, 0x7cU, 0x66U, 0x03U, 0x0dU, 
		0xc7U, 0x24U, 0x88U, 0xf3U, 0x59U, 0xffU, 0x2cU, 0x2fU, 
		0x3bU, 0xfeU, 0x38U, 0xa3U, 0x82U, 0xedU, 0x07U, 0x16U, 
		0x9aU, 0xd7U, 0x89U, 0x5dU, 0xf2U, 0x3eU, 0xfeU, 0xa9U
	}, 
	{
		0xe5U, 0xf8U, 0x1dU, 0x2eU, 0xdaU, 0x0eU, 0x92U, 0x40U, 
		0xd1U, 0xd9U, 0x07U, 0xa2U, 0x9eU, 0x60U, 0xd4U, 0xb3U, 
		0xe0U, 0xdfU, 0x74U, 0x82U, 0xcaU, 0x1bU, 0x0bU, 0xd7U, 
		0x49U, 0x96U, 0xfaU, 0x38U, 0x41U, 0x65U, 0x8cU, 0x42U, 
		0x4eU, 0xf0U, 0x3eU, 0x9bU, 0x9aU, 0x5dU, 0xf6U, 0xb3U, 
		0xadU, 0x88U, 0xa8U, 0x84U, 0x35U, 0x8dU, 0xecU, 0x5aU, 
		0x64U, 0xf7U, 0x15U, 0x55U, 0x30U, 0xf2U, 0x5eU, 0xfbU, 
		0x18U, 0xf4U, 0x3eU, 0x08U, 0xbdU, 0x87U, 0xdbU, 0x31U
	}, 
	{
		0xfbU, 0x8fU, 0xc8U, 0x0cU, 0x64U, 0xc8U, 0x06U, 0x89U, 
		0xd6U, 0x6eU, 0x44U, 0x6fU, 0x8bU, 0xb3U, 0xeeU, 0x89U, 
		0xe1U, 0x87U, 0x06U, 0x9bU, 0xa5U, 0xb5U, 0x4fU, 0x25U, 
		0x40U, 0xb5U, 0x10U, 0x90U, 0x53U, 0x4eU, 0xc1U, 0xbeU, 
		0xebU, 0x8dU, 0xfeU, 0x87U, 0x9bU, 0x42U, 0x0aU, 0xebU, 
		0x3cU, 0x76U, 0x83U, 0x54U, 0x4fU, 0x2fU, 0x5cU, 0x55U, 
		0xa2U, 0x6eU, 0x5cU, 0xd0U, 0x8cU, 0x9eU, 0x34U, 0xaeU, 
		0x66U, 0x58U, 0x39U, 0xb7U, 0xdcU, 0x1cU, 0x1dU, 0x4fU
	}, 
	{
	...
	{
		0x20U, 0xa8U, 0x00U, 0x88U, 0x0aU, 0x80U, 0x20U, 0x82U, 
		0x00U, 0x0aU, 0xa2U, 0x0aU, 0x88U, 0x82U, 0x08U, 0x2aU, 
		0x2aU, 0x2aU, 0x8aU, 0x28U, 0x28U, 0x82U, 0xa8U, 0xa0U, 
		0x00U, 0x22U, 0x82U, 0x8aU, 0x80U, 0x2aU, 0x80U, 0x00U, 
		0x08U, 0x88U, 0x0aU, 0xaaU, 0x20U, 0x82U, 0x0aU, 0xa2U, 
		0x02U, 0x00U, 0xa8U, 0x8aU, 0xaaU, 0x88U, 0x0aU, 0xa2U, 
		0x2aU, 0x8aU, 0x8aU, 0x02U, 0x28U, 0xaaU, 0x02U, 0x08U, 
		0x2aU, 0x20U, 0xaaU, 0x02U, 0x20U, 0x20U, 0x22U, 0x2aU
	}, 
	{
		0xc3U, 0xe2U, 0x6fU, 0xa4U, 0xddU, 0x6dU, 0xd9U, 0x3cU, 
		0x86U, 0x4cU, 0x59U, 0x6eU, 0x26U, 0x80U, 0x6cU, 0xfeU, 
		0xbfU, 0x75U, 0x21U, 0x3bU, 0x44U, 0x58U, 0x74U, 0xacU, 
		0xfbU, 0x41U, 0x66U, 0xc0U, 0xf2U, 0x77U, 0xdeU, 0xc8U, 
		0x5dU, 0x8cU, 0xddU, 0x20U, 0xacU, 0x99U, 0x16U, 0x4aU, 
		0xdeU, 0x1dU, 0x50U, 0xf6U, 0xb6U, 0xfbU, 0x5dU, 0x1aU, 
		0x76U, 0xe9U, 0x20U, 0x13U, 0x01U, 0x9aU, 0x4aU, 0x28U, 
		0x70U, 0xfeU, 0x02U, 0xbeU, 0xa0U, 0x29U, 0xfcU, 0x07U
	}, 
	{
		0xdaU, 0xb1U, 0x2aU, 0x1dU, 0xb1U, 0x0dU, 0x21U, 0xc1U, 
		0xa3U, 0xf6U, 0x1aU, 0x15U, 0x78U, 0x95U, 0xecU, 0x36U, 
		0xc0U, 0xeaU, 0xfcU, 0x50U, 0x85U, 0x72U, 0x57U, 0xbaU, 
		0xd3U, 0x2cU, 0xf0U, 0x30U, 0x82U, 0x8bU, 0x09U, 0xd0U, 
		0x9dU, 0xb0U, 0x68U, 0x23U, 0x34U, 0xbbU, 0xa9U, 0x26U, 
		0x4bU, 0x10U, 0x44U, 0x59U, 0x2eU, 0x5fU, 0x9cU, 0xb5U, 
		0x9dU, 0xffU, 0x3eU, 0xfbU, 0x61U, 0xf4U, 0xa9U, 0xa3U, 
		0x65U, 0xe9U, 0x6cU, 0x04U, 0x7bU, 0x1fU, 0xf7U, 0x76U
	}, 
	{
		0xf2U, 0x5eU, 0x84U, 0x1dU, 0xcdU, 0x85U, 0x49U, 0x02U, 
		0xe8U, 0xccU, 0x89U, 0xdbU, 0x47U, 0x32U, 0xc8U, 0x53U, 
		0xd2U, 0x4fU, 0x18U, 0x63U, 0x4fU, 0x2fU, 0x8fU, 0x4bU, 
		0x84U, 0x6bU, 0x75U, 0x34U, 0xa2U, 0x98U, 0xc6U, 0x29U, 
		0x87U, 0x5aU, 0xbdU, 0x4fU, 0x67U, 0x84U, 0x51U, 0xd3U, 
		0x7cU, 0xecU, 0x56U, 0xe8U, 0x9aU, 0x4eU, 0xfcU, 0xafU, 
		0x10U, 0xd9U, 0xa8U, 0xa0U, 0x18U, 0x79U, 0x2dU, 0x5dU, 
		0x8cU, 0xf0U, 0x37U, 0x2eU, 0xfcU, 0x69U, 0x6fU, 0x9aU
	}, 
	{
		0x55U, 0x45U, 0x44U, 0x04U, 0x10U, 0x44U, 0x01U, 0x44U, 
		0x41U, 0x15U, 0x00U, 0x15U, 0x45U, 0x51U, 0x55U, 0x44U, 
		0x50U, 0x41U, 0x01U, 0x45U, 0x50U, 0x50U, 0x05U, 0x10U, 
		0x00U, 0x50U, 0x00U, 0x40U, 0x01U, 0x05U, 0x40U, 0x55U, 
		0x55U, 0x44U, 0x55U, 0x41U, 0x45U, 0x01U, 0x05U, 0x55U, 
		0x14U, 0x11U, 0x41U, 0x00U, 0x05U, 0x15U, 0x04U, 0x00U, 
		0x51U, 0x15U, 0x04U, 0x40U, 0x44U, 0x45U, 0x10U, 0x55U, 
		0x11U, 0x04U, 0x14U, 0x51U, 0x44U, 0x04U, 0x04U, 0x05U
	}, 
	{
		0x20U, 0xa8U, 0x00U, 0x88U, 0x0aU, 0x80U, 0x20U, 0x82U, 
		0x00U, 0x0aU, 0xa2U, 0x0aU, 0x88U, 0x82U, 0x08U, 0x2aU, 
...
static const uint8_t KBOX_1_P[16][64] = {
	{
		0xc3U, 0xe2U, 0x6fU, 0xa4U, 0xddU, 0x6dU, 0xd9U, 0x3cU, 
		0x86U, 0x4cU, 0x59U, 0x6eU, 0x26U, 0x80U, 0x6cU, 0xfeU, 
		0xbfU, 0x75U, 0x21U, 0x3bU, 0x44U, 0x58U, 0x74U, 0xacU, 
...
static const uint8_t KBOX_2_P[16][64] = {
	{
		0xdaU, 0xb1U, 0x2aU, 0x1dU, 0xb1U, 0x0dU, 0x21U, 0xc1U, 
		0xa3U, 0xf6U, 0x1aU, 0x15U, 0x78U, 0x95U, 0xecU, 0x36U, 
		0xc0U, 0xeaU, 0xfcU, 0x50U, 0x85U, 0x72U, 0x57U, 0xbaU, 
...
static const uint8_t KBOX_3_P[16][64] = {
	{
		0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 
		0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 
		0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 
...
#define CONCATENATE_KBOX_0_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (KBOX_0_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadKBOX_0(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_KBOX_0_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_KBOX_0_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_KBOX_1_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (KBOX_1_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadKBOX_1(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_KBOX_1_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_KBOX_1_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_KBOX_2_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (KBOX_2_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadKBOX_2(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_KBOX_2_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_KBOX_2_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_KBOX_3_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (KBOX_3_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadKBOX_3(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_KBOX_3_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_KBOX_3_ITEM(15, Byte_index, Item_offset)
    return item;
}
...
#define KROUND(t, k0, k1, k2, k3, ck, sbox, rki) \
    do {                                        \
        (t) = (k1) ^ (k2) ^ (k3) ^ (ck);        \
        (k0) ^= ReadKBOX_3(((t) >> 24) & 0xff); \
        (k0) ^= ReadKBOX_2(((t) >> 16) & 0xff); \
        (k0) ^= ReadKBOX_1(((t) >> 8) & 0xff);  \
        (k0) ^= ReadKBOX_0((t) & 0xff);         \
        (rki) = (k0);                           \
    } while (0)
