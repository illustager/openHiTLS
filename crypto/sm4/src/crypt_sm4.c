...
static const uint8_t XBOX_0_P[16][64] = {
	{
	...
	{
		0x73U, 0xa7U, 0x9fU, 0x36U, 0xc9U, 0xd4U, 0xf4U, 0xffU, 
		0x4bU, 0x21U, 0xd7U, 0xb2U, 0xfdU, 0x2bU, 0x10U, 0xc0U, 
		0xeaU, 0x2fU, 0xffU, 0x83U, 0x96U, 0x45U, 0x46U, 0x2cU, 
		0x55U, 0x9bU, 0x78U, 0xa5U, 0xb1U, 0xacU, 0xafU, 0x64U, 
		0x80U, 0x28U, 0x6bU, 0x47U, 0x64U, 0x05U, 0x2eU, 0xdcU, 
		0x6eU, 0x0eU, 0x7cU, 0x1eU, 0x24U, 0x19U, 0x83U, 0x5eU, 
		0x86U, 0x39U, 0x7dU, 0x80U, 0x94U, 0x98U, 0x86U, 0x12U, 
		0x2fU, 0x6fU, 0xdcU, 0x74U, 0xe2U, 0x2cU, 0x47U, 0xb6U
	}, 
	{
		0x04U, 0x8bU, 0x08U, 0x54U, 0xbcU, 0x10U, 0xd4U, 0xd6U, 
		0x92U, 0x75U, 0x23U, 0x9dU, 0x2fU, 0x0aU, 0x48U, 0xceU, 
		0x35U, 0x4fU, 0xccU, 0x37U, 0xc0U, 0xbfU, 0xb1U, 0xa3U, 
		0xbeU, 0x9eU, 0x4bU, 0x58U, 0x10U, 0x76U, 0xcbU, 0xa6U, 
		0x60U, 0x94U, 0xfaU, 0x89U, 0xe6U, 0x3bU, 0xf5U, 0xbeU, 
		0x6aU, 0xacU, 0x20U, 0x77U, 0x6cU, 0x72U, 0xc0U, 0x75U, 
		0x5fU, 0x09U, 0x2dU, 0xf6U, 0xb2U, 0x1fU, 0x59U, 0xedU, 
		0x82U, 0x23U, 0xb7U, 0x55U, 0x4fU, 0xb9U, 0x25U, 0x98U
	}, 
	{
		0x1eU, 0x77U, 0xd5U, 0x22U, 0xbeU, 0xc6U, 0x94U, 0xc9U, 
		0x07U, 0xb7U, 0x43U, 0xcdU, 0x15U, 0xd3U, 0x3aU, 0x3aU, 
		0x01U, 0x58U, 0x72U, 0x19U, 0x6fU, 0xaeU, 0x44U, 0xf2U, 
		0x09U, 0x23U, 0xeaU, 0xa8U, 0x12U, 0x2bU, 0x4dU, 0xfcU, 
		0xa5U, 0x7dU, 0xc0U, 0x1cU, 0x01U, 0x1fU, 0xfcU, 0x58U, 
		0x91U, 0xfeU, 0x2bU, 0xd0U, 0x7aU, 0xa2U, 0xb0U, 0x0fU, 
		0xc6U, 0x99U, 0x49U, 0x85U, 0xbcU, 0x6cU, 0x6aU, 0x55U, 
		0x7eU, 0xacU, 0x07U, 0xbfU, 0x61U, 0x9bU, 0xc6U, 0x7eU
	}, 
	{
	...
	{
		0x69U, 0x5bU, 0x42U, 0x40U, 0xcbU, 0x02U, 0xb4U, 0xe0U, 
		0xdeU, 0xe3U, 0xb7U, 0xe2U, 0xc7U, 0xf2U, 0x62U, 0x34U, 
		0xdeU, 0x38U, 0x41U, 0xadU, 0x39U, 0x54U, 0xb3U, 0x7dU, 
		0xe2U, 0x26U, 0xd9U, 0x55U, 0xb3U, 0xf1U, 0x29U, 0x3eU, 
		0x45U, 0xc1U, 0x51U, 0xd2U, 0x83U, 0x21U, 0x27U, 0x3aU, 
		0x95U, 0x5cU, 0x77U, 0xb9U, 0x32U, 0xc9U, 0xf3U, 0x24U, 
		0x1fU, 0xa9U, 0x19U, 0xf3U, 0x9aU, 0xebU, 0xb5U, 0xaaU, 
		0xd3U, 0xe0U, 0x6cU, 0x9eU, 0xccU, 0x0eU, 0xa4U, 0x50U
	}, 
	{
		0xe1U, 0x73U, 0x15U, 0x7aU, 0x66U, 0x1eU, 0x46U, 0x96U, 
		0x43U, 0xacU, 0x24U, 0x3fU, 0xb1U, 0x6aU, 0x9cU, 0x7dU, 
...
static const uint8_t XBOX_1_P[16][64] = {
	{
		0x69U, 0x5bU, 0x42U, 0x40U, 0xcbU, 0x02U, 0xb4U, 0xe0U, 
		0xdeU, 0xe3U, 0xb7U, 0xe2U, 0xc7U, 0xf2U, 0x62U, 0x34U, 
		0xdeU, 0x38U, 0x41U, 0xadU, 0x39U, 0x54U, 0xb3U, 0x7dU, 
...
static const uint8_t XBOX_2_P[16][64] = {
	{
		0xfbU, 0x8fU, 0xc8U, 0x0cU, 0x64U, 0xc8U, 0x06U, 0x89U, 
		0xd6U, 0x6eU, 0x44U, 0x6fU, 0x8bU, 0xb3U, 0xeeU, 0x89U, 
		0xe1U, 0x87U, 0x06U, 0x9bU, 0xa5U, 0xb5U, 0x4fU, 0x25U, 
...
static const uint8_t XBOX_3_P[16][64] = {
	{
		0xfbU, 0x8fU, 0xc8U, 0x0cU, 0x64U, 0xc8U, 0x06U, 0x89U, 
		0xd6U, 0x6eU, 0x44U, 0x6fU, 0x8bU, 0xb3U, 0xeeU, 0x89U, 
		0xe1U, 0x87U, 0x06U, 0x9bU, 0xa5U, 0xb5U, 0x4fU, 0x25U, 
...
#define CONCATENATE_XBOX_0_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (XBOX_0_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadXBOX_0(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_XBOX_0_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_XBOX_0_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_XBOX_1_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (XBOX_1_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadXBOX_1(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_XBOX_1_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_XBOX_1_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_XBOX_2_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (XBOX_2_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadXBOX_2(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_XBOX_2_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_XBOX_2_ITEM(15, Byte_index, Item_offset)
    return item;
}

#define CONCATENATE_XBOX_3_ITEM(Table_index, Byte_index, Item_offset) \
    item |= \
    ((uint32_t) (XBOX_3_P[Table_index][Byte_index] \
    >> Item_offset >> Item_offset & 0x03U)) \
    << Table_index << Table_index;

uint32_t ReadXBOX_3(uint8_t index)
{
    uint32_t item = 0;
    uint8_t Byte_index = index >> 2;
    uint8_t Item_offset = index & 0x03U;
    CONCATENATE_XBOX_3_ITEM( 0, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 1, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 2, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 3, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 4, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 5, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 6, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 7, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 8, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM( 9, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(10, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(11, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(12, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(13, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(14, Byte_index, Item_offset)
    CONCATENATE_XBOX_3_ITEM(15, Byte_index, Item_offset)
    return item;
}
...
#define CRYPT_SM4_ROUND(t, x0, x1, x2, x3, rk, sbox)   \
    do {                                     \
        (t) = (x1) ^ (x2) ^ (x3) ^ (rk);     \
        (x0) ^= ReadXBOX_3(((t) >> 24) & 0xff); \
        (x0) ^= ReadXBOX_2(((t) >> 16) & 0xff); \
        (x0) ^= ReadXBOX_1(((t) >> 8) & 0xff);  \
        (x0) ^= ReadXBOX_0((t) & 0xff);       \
    } while (0)
